...
from core.planning.config import DEFAULT_ENCODING, DEFAULT_HORIZON, DEFAULT_TIME_STEP, ConcretePlanningConfig
...
def _argument_parser():
    ...
    parser.add_argument("--domain", required=True, default=argparse.SUPPRESS, help="Concrete domain file")
    parser.add_argument("--problem", required=True, default=argparse.SUPPRESS, help="Concrete problem file")
    parser.add_argument(
        "--horizon",
