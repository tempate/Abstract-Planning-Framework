...
from scripts.collect_benchmarks import main as collect_benchmarks
...
def main():
    ...
    if pending and not args.force:
        ...
        return
    _pull(args.host, args.remote_dir, args.dry_run)
    if not args.dry_run:
        collect_benchmarks()
