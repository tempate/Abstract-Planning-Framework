(define
	(problem beluga-problem_39_s82_j4_r2_oc23_f3)
	(:domain beluga)
  (:objects
		...
		beluga_trailer_4 - trailer
		beluga_trailer_5 - trailer
		beluga_trailer_6 - trailer
  ...
  (:init
		...
		(empty beluga_trailer_4)
		(at-side beluga_trailer_4 bside)
		(empty beluga_trailer_5)
		(at-side beluga_trailer_5 bside)
		(empty beluga_trailer_6)
		(at-side beluga_trailer_6 bside)
