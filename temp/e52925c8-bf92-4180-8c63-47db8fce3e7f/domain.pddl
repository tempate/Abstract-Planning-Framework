(define (domain beluga_prob1-domain)
 ...
 (:action unload_beluga
  ...
  :precondition (and (in ?j ?b) (empty ?t) (at_side ?t bside) (processed_flight ?b) (to_unload ?j ?b) (next_unload ?j ?nj) (started))
 ...
 (:action get_from_hangar
  ...
  :precondition (and (in ?j ?h) (empty ?t) (at_side ?t fside) (started))
 ...
 (:action deliver_to_hangar
  ...
  :precondition (and (in ?j ?t) (empty ?h) (at_side ?t fside) (to_deliver ?j ?pl) (next_deliver ?j ?jn) (size ?j ?s_1) (empty_size ?j ?es) (started))
 ...
 (:action put_down_rack
  ...
  :precondition (and (in ?j ?t) (empty ?r) (at_side ?t ?s) (at_side ?r ?s) (size ?j ?jsize) (free_space ?r ?fspace) (fit ?nspace ?jsize ?fspace ?r) (started))
 ...
 (:action stack_rack
  ...
  :precondition (and (not (= ?s ?os)) (in ?j ?t) (in ?nj ?r) (at_side ?t ?s) (at_side ?r ?s) (clear ?nj ?s) (size ?j ?jsize) (free_space ?r ?fspace) (fit ?nspace ?jsize ?fspace ?r) (started))
 ...
 (:action pick_up_rack
  ...
  :precondition (and (not (= ?s ?os)) (empty ?t) (in ?j ?r) (at_side ?t ?s) (at_side ?r ?s) (clear ?j bside) (clear ?j fside) (size ?j ?jsize) (free_space ?r ?fspace) (fit ?fspace ?jsize ?nspace ?r) (started))
 ...
 (:action unstack_rack
  :parameters ( ?j - jig ?nj - jig ?t - trailer ?r - rack ?s - side ?os - side ?jsize - num ?fspace - num ?nspace - num)
  :precondition (and (not (= ?s ?os)) (empty ?t) (in ?j ?r) (in ?nj ?r) (at_side ?t ?s) (at_side ?r ?s) (clear ?j ?s) (next_to ?j ?nj ?s) (next_to ?nj ?j ?os) (size ?j ?jsize) (free_space ?r ?fspace) (fit ?fspace ?jsize ?nspace ?r) (started))
